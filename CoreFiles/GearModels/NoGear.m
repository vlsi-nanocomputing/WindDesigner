...
flag_gear_exist(chosen_solution) = 0;   % flag used during the graph generation to identify if the component exist or not

eta_gear(chosen_solution, wind_i) = 1;
P_gear(chosen_solution, wind_i) = P_in_speed_analysis(chosen_solution, wind_i_temp);	                     
omega_gear(chosen_solution, wind_i) = turbine_omega_wind_temp(chosen_solution, wind_i_temp);                                
T_gear(chosen_solution, wind_i) = T_wind_temp(chosen_solution, wind_i_temp); 

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%  WIND DISTRIBUTION 3 - Year Analysis  %%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Percentage [/1000] of the corresponding wind speed over the time period considered
WindSpeedPercentage = [5 5 6 8 9 10 12 13 14 16 19 25 30 30 33 37 50 65 73 80 79 78 74 65 60 53 44 37];
% Wind speeds
...
WindTimeLenght = 8760;   % Lenght of the time period [hours]

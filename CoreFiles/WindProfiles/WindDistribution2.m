...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%  WIND DISTRIBUTION 2 - Monthly Analysis  %%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Percentage [/1000] of the corresponding wind speed over the time period considered
WindSpeedPercentage = [5 5 5 6 8 9 10 12 13 27 30 50 65 73 80 79 78 74 65 60 53 44 37 33 25 19 16 14];
% Wind speeds
...
WindTimeLenght = 720;   % Lenght of the time period [hours]

...
PM_p       = 6      ;      						% number of magnetic couple of poles
...
maxwind_selected = 15;    % [m/s]  MUST be an integer
% Turbine mechanical efficiency
eta_wind(chosen_solution, :) = [0 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52 0.52];
% Turbine rotation speed [rpm]
turbine_omega_wind_rpm(chosen_solution, :) = [1 64.5 95.5 127 159 191 223 255 286 318 350 382 414 446 477];
...
T_wind(chosen_solution, :) = [0 2.81 6.01 10.7 16.7 24.1 32.7 42.8 54.1 66.8 80.9 96.2 113 131 150];
for i=1:speed_range_point_special

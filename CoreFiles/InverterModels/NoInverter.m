...
flag_inverter_exist(chosen_solution) = 0;   % flag used during the graph generation to identify if the component exist or not

eta_inverter(chosen_solution, wind_i) = 1;
P_inverter(chosen_solution, wind_i) = P_filter_switching(chosen_solution, wind_i);	            
